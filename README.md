<h1 align="Center"> 💎 Acadex-Pro: The Premium Academic Evolution </h1>

<p align="center">
  <img src="https://img.shields.io/badge/Status-Live-success?style=for-the-badge&logo=github" alt="Live Status">
  <img src="https://img.shields.io/badge/UI-VIP%20Glassmorphism-fbbf24?style=for-the-badge" alt="VIP UI">
...
Visit **Acadex-Pro:**
https://masum8823.github.io/Acadex-Pro/
...
- **Accurate Academic Processing** – Ensures reliable semester GPA calculations with minimal user effort.
...
- **Semester Management & Filtering** – Easily browse, search, and organize previously saved semester records.
...
- **Quick Academic Validation** – Enables fast and convenient sharing of academic summaries through QR-based verification.
---

## 🛠️ Technology Stack

Built with a modern, lightweight, and performance-oriented technology ecosystem to deliver a premium academic management experience.
...
| **Data Storage** | Browser LocalStorage API (Privacy-focused) |
| **Verification** | QRCode.js Library |
| **Typography** | Outfit (Google Fonts) |


---

## 🚀 How to Access Acadex-Pro

You can run this project using one of the following methods:

### Method 1: Use the Live Link (Recommended)
Simply navigate to the official hosted link in your browser:  
...
- **Offline First:** Your data remains on your device. No information is ever sent to an external server.
- **100% Client-Side:** The entire application runs within the user's browser, ensuring total data privacy and high-speed performance.
...
```text
Project/
├── index.html          # VIP login interface and application entry point
├── register.html       # Student registration and onboarding page
├── dashboard.html      # GPA calculator dashboard and data vault
├── css/
│   └── style.css       # Premium UI, animations, and themes
└── js/
    ├── auth.js         # Authentication and session management
    └── calculator.js   # GPA calculation and QR generation
```
---
...
<p align="left">
  <a href="https://github.com/Masum8823">
    <img src="https://img.shields.io/badge/GitHub-Masum8823-181717?style=for-the-badge&logo=github" alt="GitHub">
  </a>
  <a href="mailto:masum8823@gmail.com">
...
---
<p align="center">
  Built with passion by <strong>MD. Abdulla Al Masum</strong>
</p>
